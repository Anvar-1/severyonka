...
from .views import UserCreateView, LoginAPIView, LogOutAPIView, UserDeleteByIdView, UserUpdateView, VerifyCodeAPIView, ChangeUserInformationView, UserProfileView, ForgotPasswordView, VerifyCodeView, ResetPasswordView, CheckUserView
